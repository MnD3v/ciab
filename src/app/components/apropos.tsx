            ...
            <div className='max flex flex-wrap gap-3'>
                ...
                <div className='w-full lg:w-[400px] xl:w-[600px]'>
                    <div className='flex items-center'>
                        <div className='h-2 w-2 bg-red-600 m-2'></div>

                        <p className='text-red-600 uppercase font-poppins font-bold'>A propos de nous</p>
                        <div className='h-2 w-2 bg-red-600 m-2'></div>

                    </div>
                    <h1 className='font-jost text-2xl md:text-3xl text-red-900 leading-tight
                    my-3
                    '>
                    ...
                    <h3 className='text-red-600 text-2xl font-bricolage'>
                        Atouts</h3>
                            ...
                            avantages.map((element) => (
                                ...
                                '>
                                    ...
                                    <div className='w-full sm:w-52'>
                                        <p className='text-red-700 font-jost text-xl font-semibold'>{element.description.split(':')[0]} </p>
