                ...
                <div className='max md:flex md:justify-between w-full  bg-red-100 p-6 md:p-16 my-12'>
                    <div className='font-bricolage w-[43%] max-md:w-full'>
                        <motion.h1
                            ...
                            Choisissez <span className='text-red-500 font-bold'>Ciab</span>  pour une satisfaction complète.
                        </motion.h1>
                        <motion.p
                    ...
                    <div className='w-full md:max-w-[43%]'>
                        ...
                        <motion.button
                            ...
                            initial="hidden"
                            whileInView="show"
                            className='bg-red-600 text-white font-semibold px-8 py-4 my-4'>Envoyer</motion.button>
                    </div>
                </div>
            ...
            <div className='flex flex-wrap justify-center gap-3 m-3'>
                {contacts.map((element) => (
                    <motion.div
                        ...
                        whileInView="show"
                        viewport={{ once: true }}
                        key={element.icon} className='w-full sm:w-96 bg-red-100 rounded-xl flex flex-col items-center p-4 gap-3'>
                        <div className='h-20 w-20 md:h-24 md:w-24 rounded-full bg-red-100 flex flex-col items-center justify-center'>
                            <img src={`/icons/${element.icon}`} alt="" className='h-10 md:h-14 ' />
                        </div>
                        <h3 className='text-red-900'>{element.title}</h3>
                        <p className='text-center'>{element.description} </p>
                        <a href="" className='text-red-900 font-bricolage px-6 py-4 bg-red-100 border border-red-600 rounded-lg'>{element.buttonText}</a>
                    </motion.div>
                ))}
            </div>
        </section>
