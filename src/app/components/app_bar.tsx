                ...
                <div className='max w-full flex flex-col items-center '>
                    ...
                    <div className='p-6 hidden justify-between w-full md:flex'>
                        ...
                        <ul className="max flex font-jost">
                            <li className="hover:text-red-600 font-semibold  border-white/30 px-6 py-3"><a href={inNotHome ? "/" : "#"}>Accueil</a></li>
                            <li className="hover:text-red-600 font-semibold  border-white/30 px-6 py-3"><a href={inNotHome ? "/" : "#formations"}>Formations</a></li>

                            <li className="hover:text-red-600 font-semibold  border-white/30 px-6 py-3"><a href={inNotHome ? "/" : "#a-propos"}>A Propos</a></li>
                            <li className="hover:text-red-600 font-semibold  border-white/30 px-6 py-3"><a href={inNotHome ? "/" : "#contact"}>Contact</a></li>
                        </ul>
                    </div>
