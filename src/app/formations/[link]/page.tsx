...
const Formation = ({ params }: { params: { link: string } }) => {
    ...
    return (
        <div>
            {
                isInView && <div className='fixed flex flex-col items-center justify-center bg-red-100 h-full w-full'>
            ...
            <motion.div
                ...
                <div
                    ...
                    className='bg-red-100 flex flex-col items-center font-jost'>
                    <AppBar></AppBar>
                    ...
                    <div className=' justify-center items-center mb-8 md:my-12 mx-2 space-y-3'>
                        ...
                        <h2 className='text-center text-xl md:text-3xl text-red-600'>{formation?.title}</h2>
                    </div>
                ...
                <div className='w-full flex justify-center'>
                    <div className='max-w-[800px] leading-relaxed'>
                        ...
                        <div className='m-2 md:m-9'>
                            ...
                            <h1 className='font-bricolage text-2xl md:text-4xl text-red-600 mt-6'>{formation?.title}</h1>
                            <div className='h-px w-28 bg-blue-900 my-3'></div>
                            <p>{formation?.full_description}</p>
                            <h2 className='text-red-600 font-bricolage mt-6'>Débouchés</h2>
                            {
                            ...
                            <h2 className='font-bricolage text-red-600 mt-6'>Unités d'enseignement</h2>
                            {
